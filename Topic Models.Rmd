...
The lines of code below are useful to merge the speech data and to transform the .csv files into corpus objects, which allow text analysis functions to be applied to the texts. We have seen similar lines of code in previous classes, so this should not be new.
...
top_topic1_docs <- top_docs[,grep("scotland",topic_lab)]
top_topic1_docs

#who speaks on the topic and when?
DFM_stm$meta[top_topic1_docs,]

#check texts
speeches[top_topic1_docs,]
speeches$text[top_topic1_docs]
speeches$text[600]
...
plot.estimateEffect(author_effect, "author", method = "difference", 
                    cov.value1 = "Penny Mordaunt", cov.value2 = "Gavin Newlands",
                    verbose.labels=F,
                    title("Mean Difference in Topic Proportions (Mordaunt-Newlands)"),
                    xlab="Left: Newlands; Right: Mordaunt")
